...
async function fetchEmployeeRecordData() {
    try {
        ...
        if (userAvatarEl && data.user.avatar) {
            ...
            userAvatarEl.onerror = function() { this.src = '../images/account.png'; }; 
        }
...
function renderEmployeeTable(employees) {
    ...
    tbody.innerHTML = employees.map(emp => {
        const avatarSrc = (emp.avatar && emp.avatar !== '/images/account.png') ? emp.avatar : '../images/account.png';
                ...
                <td>
                    <div class="cust-cell">
                        <div class="cust-avatar-sm">
                            <img src="${escapeHtml(avatarSrc)}" alt="${escapeHtml(emp.full_name)}" class="cust-avatar-img" onerror="this.onerror=null; this.src='../images/account.png';">
                        </div>
                        <div>
...
function openEmployeeModalByData(empId) {
    ...
    modalImg.src = empData.avatar || '../images/account.png';
...
function enableEditMode(isEditing) {
    ...
    if (isEditing) {
        ...
        if (currentEmpData) {
            const modalImg = document.getElementById('mAvatarImg');
            modalImg.src = currentEmpData.avatar || '../images/account.png';
            modalImg.onerror = function() { this.src = '../images/account.png'; };
        }
    }
}
